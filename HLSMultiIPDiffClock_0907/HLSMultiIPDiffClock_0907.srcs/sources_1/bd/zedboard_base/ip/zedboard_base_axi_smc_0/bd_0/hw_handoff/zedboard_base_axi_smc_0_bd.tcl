...
################################################################
# This is a generated script based on design: bd_777a
#
...
proc create_hier_cell_s08_nodes { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net m_sc_clk_1 [get_bd_pins m_sc_clk] [get_bd_pins s08_ar_node/m_sc_aclk] [get_bd_pins s08_aw_node/m_sc_aclk] [get_bd_pins s08_b_node/s_sc_aclk] [get_bd_pins s08_r_node/s_sc_aclk] [get_bd_pins s08_w_node/m_sc_aclk]
  connect_bd_net -net m_sc_resetn_1 [get_bd_pins m_sc_resetn] [get_bd_pins s08_ar_node/m_sc_aresetn] [get_bd_pins s08_aw_node/m_sc_aresetn] [get_bd_pins s08_b_node/s_sc_aresetn] [get_bd_pins s08_r_node/s_sc_aresetn] [get_bd_pins s08_w_node/m_sc_aresetn]
  connect_bd_net -net s_sc_clk_1 [get_bd_pins s_sc_clk] [get_bd_pins s08_ar_node/s_sc_aclk] [get_bd_pins s08_aw_node/s_sc_aclk] [get_bd_pins s08_b_node/m_sc_aclk] [get_bd_pins s08_r_node/m_sc_aclk] [get_bd_pins s08_w_node/s_sc_aclk]
  connect_bd_net -net s_sc_resetn_1 [get_bd_pins s_sc_resetn] [get_bd_pins s08_ar_node/s_sc_aresetn] [get_bd_pins s08_aw_node/s_sc_aresetn] [get_bd_pins s08_b_node/m_sc_aresetn] [get_bd_pins s08_r_node/m_sc_aresetn] [get_bd_pins s08_w_node/s_sc_aresetn]
...
proc create_hier_cell_m00_exit_pipeline { parentCell nameHier } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.SSC005_ROUTE {0b0000000001} \
   CONFIG.SSC006_ROUTE {0b0000000010} \
   CONFIG.SSC007_ROUTE {0b0000000100} \
   CONFIG.SSC008_ROUTE {0b0000001000} \
   CONFIG.SSC009_ROUTE {0b0000010000} \
   CONFIG.SSC010_ROUTE {0b0000100000} \
   CONFIG.SSC011_ROUTE {0b0001000000} \
   CONFIG.SSC012_ROUTE {0b0010000000} \
   CONFIG.SSC013_ROUTE {0b0100000000} \
   CONFIG.SSC014_ROUTE {0b1000000000} \
   CONFIG.SSC015_ROUTE {0b0000000000} \
...
proc create_hier_cell_clk_map { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net clk_map_aclk1_net [get_bd_pins S05_ACLK] [get_bd_pins S06_ACLK] [get_bd_pins S07_ACLK] [get_bd_pins S08_ACLK] [get_bd_pins S09_ACLK] [get_bd_pins aclk1] [get_bd_pins psr_aclk1/slowest_sync_clk]
  connect_bd_net -net clk_map_aclk_net [get_bd_pins M00_ACLK] [get_bd_pins S00_ACLK] [get_bd_pins S01_ACLK] [get_bd_pins S02_ACLK] [get_bd_pins S03_ACLK] [get_bd_pins S04_ACLK] [get_bd_pins aclk] [get_bd_pins swbd_aclk] [get_bd_pins psr0/slowest_sync_clk] [get_bd_pins psr_aclk/slowest_sync_clk]
  ...
  connect_bd_net -net psr_aclk1_interconnect_aresetn [get_bd_pins S05_ARESETN] [get_bd_pins S06_ARESETN] [get_bd_pins S07_ARESETN] [get_bd_pins S08_ARESETN] [get_bd_pins S09_ARESETN] [get_bd_pins psr_aclk1/interconnect_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S05_AXI:S06_AXI:S07_AXI:S08_AXI:S09_AXI} \
 ] $aclk1
  ...
  connect_bd_intf_net -intf_net S_SC_AR_7 [get_bd_intf_pins s06_axi2sc/M_SC_AR] [get_bd_intf_pins s06_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_8 [get_bd_intf_pins s07_axi2sc/M_SC_AR] [get_bd_intf_pins s07_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_9 [get_bd_intf_pins s08_axi2sc/M_SC_AR] [get_bd_intf_pins s08_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_10 [get_bd_intf_pins s09_axi2sc/M_SC_AR] [get_bd_intf_pins s09_nodes/S_SC_AR]
  connect_bd_intf_net -intf_net S_SC_AR_11 [get_bd_intf_pins m00_nodes/S_SC_AR] [get_bd_intf_pins switchboards/M00_SC_AR]
  ...
  connect_bd_intf_net -intf_net S_SC_AW_6 [get_bd_intf_pins s05_axi2sc/M_SC_AW] [get_bd_intf_pins s05_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_7 [get_bd_intf_pins s06_axi2sc/M_SC_AW] [get_bd_intf_pins s06_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_8 [get_bd_intf_pins s07_axi2sc/M_SC_AW] [get_bd_intf_pins s07_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_9 [get_bd_intf_pins s08_axi2sc/M_SC_AW] [get_bd_intf_pins s08_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_10 [get_bd_intf_pins s09_axi2sc/M_SC_AW] [get_bd_intf_pins s09_nodes/S_SC_AW]
  connect_bd_intf_net -intf_net S_SC_AW_11 [get_bd_intf_pins m00_nodes/S_SC_AW] [get_bd_intf_pins switchboards/M00_SC_AW]
  ...
  connect_bd_intf_net -intf_net S_SC_B_6 [get_bd_intf_pins s05_nodes/S_SC_B] [get_bd_intf_pins switchboards/M05_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_7 [get_bd_intf_pins s06_nodes/S_SC_B] [get_bd_intf_pins switchboards/M06_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_8 [get_bd_intf_pins s07_nodes/S_SC_B] [get_bd_intf_pins switchboards/M07_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_9 [get_bd_intf_pins s08_nodes/S_SC_B] [get_bd_intf_pins switchboards/M08_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_10 [get_bd_intf_pins s09_nodes/S_SC_B] [get_bd_intf_pins switchboards/M09_SC_B]
  connect_bd_intf_net -intf_net S_SC_B_11 [get_bd_intf_pins m00_nodes/S_SC_B] [get_bd_intf_pins m00_sc2axi/M_SC_B]
  ...
  connect_bd_intf_net -intf_net S_SC_R_7 [get_bd_intf_pins s06_nodes/S_SC_R] [get_bd_intf_pins switchboards/M06_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_8 [get_bd_intf_pins s07_nodes/S_SC_R] [get_bd_intf_pins switchboards/M07_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_9 [get_bd_intf_pins s08_nodes/S_SC_R] [get_bd_intf_pins switchboards/M08_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_10 [get_bd_intf_pins s09_nodes/S_SC_R] [get_bd_intf_pins switchboards/M09_SC_R]
  connect_bd_intf_net -intf_net S_SC_R_11 [get_bd_intf_pins m00_nodes/S_SC_R] [get_bd_intf_pins m00_sc2axi/M_SC_R]
  ...
  connect_bd_intf_net -intf_net S_SC_W_6 [get_bd_intf_pins s05_axi2sc/M_SC_W] [get_bd_intf_pins s05_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_7 [get_bd_intf_pins s06_axi2sc/M_SC_W] [get_bd_intf_pins s06_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_8 [get_bd_intf_pins s07_axi2sc/M_SC_W] [get_bd_intf_pins s07_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_9 [get_bd_intf_pins s08_axi2sc/M_SC_W] [get_bd_intf_pins s08_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_10 [get_bd_intf_pins s09_axi2sc/M_SC_W] [get_bd_intf_pins s09_nodes/S_SC_W]
  connect_bd_intf_net -intf_net S_SC_W_11 [get_bd_intf_pins m00_nodes/S_SC_W] [get_bd_intf_pins switchboards/M00_SC_W]
