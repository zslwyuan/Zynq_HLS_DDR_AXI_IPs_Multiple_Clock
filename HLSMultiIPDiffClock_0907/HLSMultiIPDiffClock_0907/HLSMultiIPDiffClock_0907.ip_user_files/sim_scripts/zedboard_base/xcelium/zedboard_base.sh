...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../HLSExtractedIntoIP.srcs/sources_1/bd/zedboard_base/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../HLSExtractedIntoIP.srcs/sources_1/bd/zedboard_base/ipshared/5bb9/hdl/verilog" \
       +incdir+"$ref_dir/../../../../HLSExtractedIntoIP.srcs/sources_1/bd/zedboard_base/ipshared/70fd/hdl" \
       +incdir+"$ref_dir/../../../../HLSExtractedIntoIP.srcs/sources_1/bd/zedboard_base/ipshared/f90c/hdl/verilog" \
       +incdir+"../../../../HLSExtractedIntoIP.srcs/sources_1/bd/zedboard_base/ipshared/ec67/hdl" \
       +incdir+"../../../../HLSExtractedIntoIP.srcs/sources_1/bd/zedboard_base/ipshared/5bb9/hdl/verilog" \
       +incdir+"../../../../HLSExtractedIntoIP.srcs/sources_1/bd/zedboard_base/ipshared/70fd/hdl" \
       +incdir+"../../../../HLSExtractedIntoIP.srcs/sources_1/bd/zedboard_base/ipshared/f90c/hdl/verilog" \
       +incdir+"/opt/Xilinx_201802/Vivado/2018.2/data/xilinx_vip/include"
}
