...
reg   [0:0] exitcond_flatten_i_reg_270;
reg   [0:0] exitcond_flatten_i_reg_270_pp0_iter2_reg;
reg    D_output_AXI_blk_n_W;
reg    ap_enable_reg_pp0_iter4;
reg   [0:0] exitcond_flatten_i_reg_270_pp0_iter3_reg;
reg    D_output_AXI_blk_n_B;
reg    ap_enable_reg_pp0_iter9;
reg   [0:0] exitcond_flatten_i_reg_270_pp0_iter8_reg;
reg    D_output_AXI_offset_blk_n;
reg   [8:0] indvar_flatten_i_reg_109;
reg   [4:0] i_i_reg_120;
reg   [4:0] j_i_reg_131;
wire   [31:0] sext_cast_i_fu_152_p1;
reg   [31:0] sext_cast_i_reg_265;
reg    ap_block_state1;
...
reg   [0:0] exitcond_flatten_i_reg_270_pp0_iter1_reg;
reg   [0:0] exitcond_flatten_i_reg_270_pp0_iter4_reg;
reg   [0:0] exitcond_flatten_i_reg_270_pp0_iter5_reg;
reg   [0:0] exitcond_flatten_i_reg_270_pp0_iter6_reg;
reg   [0:0] exitcond_flatten_i_reg_270_pp0_iter7_reg;
wire   [8:0] indvar_flatten_next_s_fu_162_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [4:0] j_mid2_i_fu_180_p3;
reg   [4:0] j_mid2_i_reg_279;
wire   [4:0] tmp_mid2_v_i_fu_188_p3;
reg   [4:0] tmp_mid2_v_i_reg_284;
wire   [4:0] j_fu_196_p2;
wire  signed [11:0] tmp_5_i_fu_237_p2;
reg  signed [11:0] tmp_5_i_reg_296;
wire   [31:0] sum_i_fu_250_p2;
...
wire  signed [63:0] tmp_5_cast_i_fu_246_p1;
wire  signed [63:0] sum_cast_i_fu_255_p1;
...
wire   [9:0] tmp_i_fu_202_p3;
wire   [7:0] tmp_3_i_fu_213_p3;
wire   [10:0] p_shl_cast_i_fu_209_p1;
wire   [10:0] p_shl2_cast_i_fu_220_p1;
wire   [10:0] tmp_4_i_fu_224_p2;
wire  signed [11:0] tmp_4_cast_i_fu_230_p1;
wire   [11:0] tmp_2_cast_i_fu_234_p1;
wire  signed [31:0] tmp_5_cast10_i_fu_243_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_flatten_i_reg_270_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_flatten_i_reg_270_pp0_iter3_reg == 1'd0) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
            if ((1'b0 == ap_block_pp0_stage0_11001)) begin
                ap_reg_ioackin_m_axi_D_output_AXI_WREADY <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten_i_reg_270 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_i_reg_120 <= tmp_mid2_v_i_reg_284;
    end else if ((~((1'b0 == D_output_AXI_offset_empty_n) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        i_i_reg_120 <= 5'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten_i_reg_270_pp0_iter2_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        exitcond_flatten_i_reg_270 <= exitcond_flatten_i_fu_156_p2;
        exitcond_flatten_i_reg_270_pp0_iter1_reg <= exitcond_flatten_i_reg_270;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        exitcond_flatten_i_reg_270_pp0_iter2_reg <= exitcond_flatten_i_reg_270_pp0_iter1_reg;
        exitcond_flatten_i_reg_270_pp0_iter3_reg <= exitcond_flatten_i_reg_270_pp0_iter2_reg;
        exitcond_flatten_i_reg_270_pp0_iter4_reg <= exitcond_flatten_i_reg_270_pp0_iter3_reg;
        exitcond_flatten_i_reg_270_pp0_iter5_reg <= exitcond_flatten_i_reg_270_pp0_iter4_reg;
        exitcond_flatten_i_reg_270_pp0_iter6_reg <= exitcond_flatten_i_reg_270_pp0_iter5_reg;
        exitcond_flatten_i_reg_270_pp0_iter7_reg <= exitcond_flatten_i_reg_270_pp0_iter6_reg;
        exitcond_flatten_i_reg_270_pp0_iter8_reg <= exitcond_flatten_i_reg_270_pp0_iter7_reg;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_flatten_i_fu_156_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        j_mid2_i_reg_279 <= j_mid2_i_fu_180_p3;
    end
end

always @ (posedge ap_clk) begin
    if ((~((1'b0 == D_output_AXI_offset_empty_n) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        sext_cast_i_reg_265[29 : 0] <= sext_cast_i_fu_152_p1[29 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_flatten_i_reg_270_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        sum_i_reg_302 <= sum_i_fu_250_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_flatten_i_reg_270 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_5_i_reg_296 <= tmp_5_i_fu_237_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_flatten_i_fu_156_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_mid2_v_i_reg_284 <= tmp_mid2_v_i_fu_188_p3;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_i_reg_270_pp0_iter2_reg == 1'd0) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_i_reg_270_pp0_iter8_reg == 1'd0) & (ap_enable_reg_pp0_iter9 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_i_reg_270_pp0_iter3_reg == 1'd0) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond_flatten_i_reg_270 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_mux_i_i_phi_fu_124_p4 = tmp_mid2_v_i_reg_284;
    end else begin
...
always @ (*) begin
    if (((exitcond_flatten_i_reg_270_pp0_iter2_reg == 1'd0) & (ap_reg_ioackin_m_axi_D_output_AXI_AWREADY == 1'b0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter3 == 1'b1))) begin
...
always @ (*) begin
    if (((exitcond_flatten_i_reg_270_pp0_iter8_reg == 1'd0) & (ap_enable_reg_pp0_iter9 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((exitcond_flatten_i_reg_270_pp0_iter3_reg == 1'd0) & (ap_reg_ioackin_m_axi_D_output_AXI_WREADY == 1'b0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond_flatten_i_fu_156_p2 == 1'd1)) & ~((ap_enable_reg_pp0_iter8 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter9 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond_flatten_i_fu_156_p2 == 1'd1)) | ((ap_enable_reg_pp0_iter8 == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter9 == 1'b1)))) begin
...
assign D_output_address0 = tmp_5_cast_i_fu_246_p1;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((exitcond_flatten_i_reg_270_pp0_iter8_reg == 1'd0) & (m_axi_D_output_AXI_BVALID == 1'b0) & (ap_enable_reg_pp0_iter9 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((exitcond_flatten_i_reg_270_pp0_iter8_reg == 1'd0) & (m_axi_D_output_AXI_BVALID == 1'b0) & (ap_enable_reg_pp0_iter9 == 1'b1)) | ((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter4 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter3 == 1'b1)) | ((exitcond_flatten_i_reg_270_pp0_iter8_reg == 1'd0) & (m_axi_D_output_AXI_BVALID == 1'b0) & (ap_enable_reg_pp0_iter9 == 1'b1)) | ((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter4 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state11_pp0_stage0_iter9 = ((exitcond_flatten_i_reg_270_pp0_iter8_reg == 1'd0) & (m_axi_D_output_AXI_BVALID == 1'b0));
end
...
always @ (*) begin
    ap_block_state5_io = ((exitcond_flatten_i_reg_270_pp0_iter2_reg == 1'd0) & (ap_sig_ioackin_m_axi_D_output_AXI_AWREADY == 1'b0));
end

assign ap_block_state5_pp0_stage0_iter3 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state6_io = ((exitcond_flatten_i_reg_270_pp0_iter3_reg == 1'd0) & (ap_sig_ioackin_m_axi_D_output_AXI_WREADY == 1'b0));
end
...
assign j_fu_196_p2 = (j_mid2_i_fu_180_p3 + 5'd1);
...
assign m_axi_D_output_AXI_AWADDR = sum_cast_i_fu_255_p1;
...
assign p_shl2_cast_i_fu_220_p1 = tmp_3_i_fu_213_p3;

assign p_shl_cast_i_fu_209_p1 = tmp_i_fu_202_p3;

assign sext_cast_i_fu_152_p1 = tmp_fu_142_p4;

assign sum_cast_i_fu_255_p1 = $signed(sum_i_reg_302);

assign sum_i_fu_250_p2 = ($signed(sext_cast_i_reg_265) + $signed(tmp_5_cast10_i_fu_243_p1));

assign tmp_2_cast_i_fu_234_p1 = j_mid2_i_reg_279;

assign tmp_3_i_fu_213_p3 = {{tmp_mid2_v_i_reg_284}, {3'd0}};

assign tmp_4_cast_i_fu_230_p1 = $signed(tmp_4_i_fu_224_p2);

assign tmp_4_i_fu_224_p2 = (p_shl_cast_i_fu_209_p1 - p_shl2_cast_i_fu_220_p1);

assign tmp_5_cast10_i_fu_243_p1 = tmp_5_i_reg_296;

assign tmp_5_cast_i_fu_246_p1 = tmp_5_i_reg_296;

assign tmp_5_i_fu_237_p2 = ($signed(tmp_4_cast_i_fu_230_p1) + $signed(tmp_2_cast_i_fu_234_p1));

assign tmp_fu_142_p4 = {{D_output_AXI_offset_dout[31:2]}};

assign tmp_i_fu_202_p3 = {{tmp_mid2_v_i_reg_284}, {5'd0}};

assign tmp_mid2_v_i_fu_188_p3 = ((exitcond9_i_fu_174_p2[0:0] === 1'b1) ? i_1_i_fu_168_p2 : ap_phi_mux_i_i_phi_fu_124_p4);

always @ (posedge ap_clk) begin
    sext_cast_i_reg_265[31:30] <= 2'b00;
end
